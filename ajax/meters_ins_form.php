...
$select_sum_divisional = '<select name="SUM_DIVISIONAL" id="SUM_DIVISIONAL" class="dn" style="width:150px"><option value="0">- '.CHOOSE.'</option>'.$select_meters.'</select>';
$select_acs = '<select name="ACS" id="ACS" style="width:150px"><option value="">- '.CHOOSE.'</option>'.$select_meters.'</select>';
$select_ete = '<select name="ETE" id="ETE" style="width:150px"><option value="">- '.CHOOSE.'</option>'.$select_meters.'</select>';
$select_combustibile = '<select name="FUEL" id="FUEL" style="width:150px"><option value="">- '.CHOOSE.'</option>'.$select_meters.'</select>';
unset($select_meters);
...
<label for="altre_utenze">
<div class="lbl"><?=ALTRE_UTENZE?></div>
<input type="checkbox" id="altre_utenze" name="altre_utenze" />
</label><br />
<?=$select_sum_divisional?>
</div>

<!-- ENERGIA TERMICA -->
<div id="thermal" class="dn">
<div class="lbl"><?=THERMAL_TYPE?></div>
<select id="choose_thermal" name="THERMAL_TYPE" style="width:150px;">
<option value=""></option>
<option value="1"><?=SOLARE_TERMICO?></option>
<option value="2"><?=GENERATORE?></option>
</select>

<div id="thermal-1">

<div class="lbl"><?=SIZE_THERMAL?></div>
<input id="SIZE_THERMAL" name="SIZE_THERMAL" type="text" value=""><br />

<div class="lbl"><?=ACS_METER?></div>
<?=$select_acs?><br />

<div class="lbl"><?=ETE_METER?></div>
<?=$select_ete?>
</div>

<div id="thermal-2">
<div class="lbl"><?=FUEL_METER?></div>
<?=$select_combustibile?><br />
</div>
...
<div id="IS_12" class="hide">
<div class="bfloat"><div class="lbl"><?=IS_12?></div><? $db -> IS_12 -> get(); ?></div>
</div>
<div class="rf">
