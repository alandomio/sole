...
# CONFIGURAZIONE NW
$aStripExt = array();
if($MYFILE -> file != 'buildings_address.php')$aStripExt = array('LAT_BLD', 'LNG_BLD', 'ADDRESS_BLD', 'K1_ID_STATI', 'K1_ID_REGIONI', 'K1_ID_PROVINCE', 'K1_ID_COMUNI');
...
$aShowList = array('ID_FILE', 'CODE_BLD', 'CODE_HC', 'YEAR_BLD');
...
$my_vars = new ordinamento(array('bl' => 'BUILDING', 'hc' => 'CODE_HC', 'yb' => 'YEAR_BLD', 'cd' => 'CODE_BLD'));
