...
/* 		new dirs($scheda->img_alb_big);
		...
		if($save_main && $save_web && $save_thu && $save_sqr) { # CANCELLO I VECCHI FILE SE I NUOVI SONO STATI SALVATI
			...
			echo 'Immagini non salvate'.BR;
			echo 'Main: '.$save_main.BR;
			echo 'Web: '.$save_web.BR;
			echo 'Thu: '.$save_thu.BR;
			echo 'Sqr: '.$save_sqr.BR;
		}
		...
		$new_id=mysql_insert_id();
		mysql_query("INSERT INTO ".$scheda -> file_table." (ID_FILE, ".$scheda->f_id.") VALUES ('$new_id', '$id')");
		echo "File salvati";
	}
}
