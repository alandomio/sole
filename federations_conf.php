...
# CONFIGURAZIONE NW
$aStripC = array('ID_FILE', 'LAT_FED', 'LNG_FED', 'DESCRIP_FED', 'PASSWORD', 'NAME', 'SURNAME','ID_GRUPPI','IS_PRIVACY','IS_CONFIRMED','IS_ABIL','IS_UPLOADER','CODE','TS', 'ID_HCOMPANY', stringa::tbl2id($scheda->table));
...
if($user->aUser['ID_GRUPPI'] == '2'){ # FACCIO VEDERE LE FEDERAZIONI SOLAMENTE AL RELATIVO GM
	$aStripC[] = 'ID_USER';
	...
	if($MYFILE -> filename == 'federations'){
		...
		else{ # NON CI SONO GM ASSEGNATI ALLA FEDERAZIONE, QUINDI REDIRECT IN HOMEPAGE
...
$sub_nav[COEFFICIENTS] = array('federations_conversions.php');
$sub_nav[USAGE] = array('federations_usages.php');
