...
# CONFIGURAZIONE NW
$scheda->ext_table(array('metertypes'));

# VISUALIZZAZIONE LISTA
$strcut = 30;

$aStripC = array();
$aShowList = array('REGISTERNUM','METERTYPE');
$aShowCrud = array_diff($scheda -> aFields, $aStripC);

# CONFIGURAZIONE FILTRI
$my_vars = new ordinamento(array('rn' => 'REGISTERNUM', 'mt' => 'METERTYPE'));
...
$aInfo = array();
$sub_nav['Appartamenti'] = array('flats_c.php');
$sub_nav['Contatori ('.$tot_ext.')'] = array('flats_meters_ext.php');
...
foreach($rs as $rec){
	...
	// if($rec['NOME_CAMPO'] == 'valore') $rec['NOME_CAMPO'] = 'pippo';
	//include BLOCCHI_AR.'list_files.php';
	//include BLOCCHI_AR.'list_image.php';
