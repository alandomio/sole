...
<tr><td colspan="2"><img src="<?=ABS_PATH_CONTATTI?>header_nl.png" alt="<?=NOME_SITO?>" width="<?=$img[0]?>" height="<?=$img[1]?>" border="0" /></td></tr>
<tr><td colspan="2" style="padding:3px 0; border-bottom:5px solid #000000; border-top:5px solid #000000;"><div align="right"><strong><font color="#000000" size="2" face="Geneva, Arial, Helvetica, sans-serif"><?=date('d/m/Y',time())?></font></strong></div></td></tr>
<tr><td>
<?=$send_message?>
</td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2" align="center" style="border-top:5px solid #000000;">
