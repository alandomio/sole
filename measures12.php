...
<?php
if($user -> idg <= 2){
	print '<br /><br /><input type="button" id="delete-ms" value="'.DELETE.' '.strtolower(MENU_MEASURES).'" class="g-button g-button-red" style="width:200px; margin-top:16px;" />';
}
?>
	<div id="del-measures" class="hidden">
		<p><?=MONTH?>:</p>
		<?=sole::select_months('upload_type')?>
	</div>
</div>
...
<? print sole::select_months('month_download') ?>
</form>
</div>
