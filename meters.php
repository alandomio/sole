...
foreach($rs as $rec){
	...
	# HREF CONTESTUALI
	$href[DETAILS]=io::a('meters-measures.php', array_merge($backUriIds, array('crud' => 'upd')), DETAILS, array('class' => 'href'));
...
$href_new = io::a('meters-measures.php', array_merge($backUri,array()), L_NUOVO, array('title' => 'Aggiungi nuovo record', 'class' => 'g-button'));
...
<tr class="search"><?=$my_vars->ricerca?><th align="right" width="200"><input id="button" <?=$my_vars->sortbutton;?> class="g-button" type="submit" value="<?=FIND?>" name="button"/></th></tr>
<?=$lista?>
