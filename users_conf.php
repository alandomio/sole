...
'ID_FEDERATION', 'CODE_HC', 'PATH_HCOMPANY', 'DESCRIP_HC', 'NAME_HC', 'ADDRESS_HC', 'REFERENCE_HC', 'EXT_ID_HCOMPANY'
...
$my_vars = new ordinamento(array('gp'=>'GRUPPI', 'us'=>'USER', 'iab'=>'IS_ABIL', 'ic' => 'IS_CONFIRMED', 'ip' => 'IS_PRIVACY', 'iu' => 'IS_UPLOADER', 'nm' => 'NAME', 'sn' => 'SURNAME', 'bld' => 'ID_BUILDING'));
...
$scheda->etichetta = 'utenti'; // 'se non specificata qui, è il nome tabella senza la s finale'
//$etichetta = $rec_scheda['USER'].' - '.$rec_scheda['ALIAS'];
